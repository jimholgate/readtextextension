...
class SpdFormats(object):
    ...
    def speak_spd(
        self, output_module="", language="", voice="", i_rate=0, _file_spec=""
    ):  # -> bool
...
class SayFormats(object):
    ...
    def __init__(self):
        ...
        self.block_list = ["Agnes", "Albert", "Zarvox"]
        # First item must be `""` for `grep` command to work.
        self.grep_block_list = [
            "",
            "Agnes",
            "Albert",
            "Enhanced",
        ...
        self.spd_table = [
            ...
            ["Flo (French (France))", "fr_FR", self.osx_13, "CHILD_FEMALE2", 131],
            ["Flo (Spanish (Mexico))", "es_MX", self.osx_13, "CHILD_FEMALE2", 131],
            ...
            ["Flo (English (U.S.))", "en_US", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (English (U.S.))", "en_US", self.osx_13, "FEMALE3", 146],
            ["Shelley (English (U.S.))", "en_US", self.osx_13, "FEMALE4", 146],
            ["Sandy (English (U.S.))", "en_US", self.osx_13, "CHILD_FEMALE1", 145],
            ["Oliver", "en_GB", self.osx_11_13, "MALE2", 181],
            ["Flo (German (Germany))", "de_DE", self.osx_13, "FEMALE2", 131],
            ["Grandma (German (Germany))", "de_DE", self.osx_13, "FEMALE3", 146],
            ["Shelley (German (Germany))", "de_DE", self.osx_13, "FEMALE4", 146],
            ["Sandy (German (Germany))", "de_DE", self.osx_13, "CHILD_FEMALE1", 145],
            ...
            ["Flo (English (U.K.))", "en_GB", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (English (U.K.))", "en_GB", self.osx_13, "FEMALE3", 146],
            ["Kate", "en_GB", self.osx_13, "FEMALE4", 181],
            ["Sandy (English (U.K.))", "en_GB", self.osx_13, "CHILD_FEMALE1", 180],
            ...
            ["Flo (Spanish (Spain))", "es_ES", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (Spanish (Spain))", "es_ES", self.osx_13, "FEMALE3", 146],
            ["Shelley (Spanish (Spain))", "es_ES", self.osx_13, "FEMALE4", 146],
            ["Sandy (Spanish (Spain))", "es_ES", self.osx_13, "CHILD_FEMALE", 145],
            ...
            ["Grandma (Spanish (Mexico))", "es_MX", self.osx_13, "FEMALE2", 146],
            ["Shelley (Spanish (Mexico))", "es_MX", self.osx_13, "FEMALE3", 146],
            ["Sandy (Spanish (Mexico))", "es_MX", self.osx_13, "CHILD_FEMALE", 180],
            ...
            ["Grandma (French (France))", "fr_FR", self.osx_13, "FEMALE2", 146],
            ["Shelley (French (France))", "fr_FR", self.osx_13, "FEMALE3", 146],
            ["Sandy (French (France))", "fr_FR", self.osx_13, "CHILD_FEMALE", 145],
            ...
            ["Flo (French (Canada))", "fr_CA", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (French (Canada))", "fr_CA", self.osx_13, "FEMALE3", 146],
            ["Shelley (French (Canada))", "fr_CA", self.osx_13, "FEMALE4", 146],
            ["Sandy (French (Canada))", "fr_CA", self.osx_13, "CHILD_FEMALE", 160],
            ...
            ["Flo (Finnish (Finland))", "fi_FI", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (Finnish (Finland))", "fi_FI", self.osx_13, "FEMALE3", 146],
            ["Sandy (Finnish (Finland))", "fi_FI", self.osx_13, "CHILD_FEMALE", 145],
            ["Shelley (Finnish (Finland))", "fi_FI", self.osx_13, "FEMALE2", 146],
            ["Grandpa (Finnish (Finland))", "fi_FI", self.osx_13, "MALE2", 145],
            ["Reed (Finnish (Finland))", "fi_FI", self.osx_13, "MALE3", 145],
            ["Rocko (Finnish (Finland))", "fi_FI", self.osx_13, "MALE4", 145],
            ["Flo (Italian (Italy))", "it_IT", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (Italian (Italy))", "it_IT", self.osx_13, "FEMALE3", 146],
            ["Shelley (Italian (Italy))", "it_IT", self.osx_13, "FEMALE4", 146],
            ["Sandy (Italian (Italy))", "it_IT", self.osx_13, "CHILD_FEMALE", 145],
            ...
            ["Flo (Portuguese (Brazil))", "pt_BR", self.osx_13, "CHILD_FEMALE2", 131],
            ["Grandma (Portuguese (Brazil))", "pt_BR", self.osx_13, "FEMALE3", 146],
            ["Shelley (Portuguese (Brazil))", "pt_BR", self.osx_13, "FEMALE4", 146],
            ["Sandy (Portuguese (Brazil))", "pt_BR", self.osx_13, "CHILD_FEMALE", 145],
            ["Eddy (Portuguese (Brazil))", "pt_BR", self.osx_13, "MALE2", 145],
            ["Grandpa (Portuguese (Brazil))", "pt_BR", self.osx_13, "MALE3", 145],
            ["Reed (Portuguese (Brazil))", "pt_BR", self.osx_13, "MALE4", 145],
            ["Rocko (Portuguese (Brazil))", "pt_BR", self.osx_13, "MALE5", 145],
        ...
        if len(self._f) == 0:
            if os.name == "nt":
                ...
                self._f = "WAVE  WAVE                 (.wav) [lpcm,ulaw,alaw]\n"
    ...
    def spd_voice_to_say_voice(self, _use_voice="FEMALE1", _lang="en-US"):  # -> str
                ...
                if _line.startswith(_item[_i_say]):
                    ...
                    for _xyxx in range(0, _ubound_count_label):
                        if _item[_i_spd].startswith(_count_label[_xyxx]):
                            found_g = "".join(
                                [_count_label[_xyxx], str(_count[_xyxx]).strip()]
                            )
                    ...
                    if len(found_g) != 0:
                        ...
                        _display_lang = "".join([_alt_lang, _country]).replace("_", "-")
                        word_rate = _item[_i_word_rate]
                        _say_voice = _line.split(_alt_lang)[0].strip()
                        _a4.append([found_g, _display_lang, _say_voice, word_rate])
        if self.debug and 1:
            print(_a4)
...
{}""".format(
    ...
    def say_aloud(
        self, _file_spec="", _voice="", _requested_voice="", i_rate=0
    ):  # -> bool
    ...
    def save_audio(
        ...
        _media_work = (
            readtexttools.get_work_file_path(_media_out, _icon, "TEMP") + ".aiff"
        )
        # Remove old files.
